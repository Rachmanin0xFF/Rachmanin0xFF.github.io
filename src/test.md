...
![bad dithering examples](bad_dither.png)
...
![anisotropy example](anisotropy.png)
...
![starfruit and its 2D Fourier transform](starfruit_both.png)
...
![ideal spectrum](ideal_spectrum.png)
...
![process sum plots](process_sum.png)
...
![alpha beta gamma visualization](alphabetagamma.png)
...
![gamma correction demonstration](same_bright.png)
